...
| `CONTENT-ART-2` | optional wordmarks and Grid icons, retaining v1 reader support | [`docs/content-paks.md`](docs/content-paks.md) |
...
contracts/
  ...
  leaf-services/    SVC-1 and friends; also hosts minischema.py, shared by both
docs/
...
subset both validators use. It lives in one place and is imported, never
